...
Chloride on Deck Calculation (\mref{mCalculation_result}) & \href{https://github.com/smiths/BridgeChlorideExposurePredictor/blob/main/src/database/chloride_on_deck.py}{chloride\_on\_deck.py}\\
